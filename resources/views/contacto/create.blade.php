...
@section('content')
        ...
        <div class="flex justify-center gap-12 xl:gap-24 text-center">
            ...
            <div class="flex flex-col p-4 gap-4 justify-center bg-yellow-300 rounded-2xl">
                <div class="flex items-center justify-center gap-1.5">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"><path fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0-18 0m9 0H8.5M12 7v5"/></svg>
    ...
    <section class="p-12 w-full">
        ...
        <form method="POST" action="{{ route('contacto.store') }}" class="bg-green-500 text-white p-4 rounded-l-xl flex flex-col gap-2">
    @csrf

    <h1 class="font-bold text-3xl">¿Tienes alguna duda o consulta?</h1>
    <p class="py-4">Comunica tus preguntas a nuestro equipo a través de este formulario. Estamos aquí para ayudarte.</p>

    <!-- Campo para el nombre prellenado -->
    <label for="nombre">Nombre</label>
    <input id="nombre" type="text" name="nombre" placeholder="Nombre" class="w-full p-2 rounded-xl text-black" value="{{ auth()->user()->name }}" readonly>

    <!-- Campo para el correo prellenado -->
    <label for="correo">Correo</label>
    <input id="correo" type="email" name="correo" placeholder="Correo" class="w-full p-2 rounded-xl text-black" value="{{ auth()->user()->email }}" readonly>

    <!-- Resto de los campos -->
    <label for="telefono">Teléfono</label>
    <input id="telefono" type="text" name="telefono" placeholder="Teléfono" class="w-full p-2 rounded-xl text-black">

    <label for="asunto">Asunto</label>
    <input id="asunto" type="text" name="asunto" placeholder="Asunto" class="w-full p-2 rounded-xl text-black">

    <label for="descripcion">Descripción</label>
    <textarea id="descripcion" name="descripcion" placeholder="Mensaje" class="w-full p-2 rounded-xl text-black"></textarea>
